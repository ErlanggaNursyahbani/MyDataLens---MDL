              ...
              <div className="rounded-lg border border-zinc-800 bg-zinc-900/40">
                ...
                >
                  <span className="flex items-center gap-2">
                    ...
                    {showPersona ? '− Remove role / persona' : '+ Add role / persona (optional)'}
                  </span>
                </button>
                {showPersona && (
                  <div className="px-4 pb-4">
                    <textarea
                      value={rolePersona}
                      onChange={(e) => {
                        setRolePersona(e.target.value)
                        setShowConfirm(false)
                        setPreviewRows(null)
                      }}
                      rows={2}
                      placeholder="e.g. You are a senior data analyst with expertise in e-commerce metrics."
